        ...
        if (Array.isArray(value) || value instanceof Set) {
            ...
            for (const key of keys) {
                ...
                if (!this.options.ignoreDecorators && targetType) {
                    if (this.transformationType === enums_1.TransformationType.PLAIN_TO_CLASS) {
                        const exposeMetadata = storage_1.defaultMetadataStorage.findExposeMetadataByCustomName(targetType, key, this.transformationType);
                        if (exposeMetadata === null || exposeMetadata === void 0 ? void 0 : exposeMetadata.propertyName) {
                        ...
                        this.transformationType === enums_1.TransformationType.CLASS_TO_CLASS) {
                        const exposeMetadata = storage_1.defaultMetadataStorage.findExposeMetadata(targetType, key, this.transformationType);
        ...
        if (!this.options.ignoreDecorators && target) {
            ...
            if (this.transformationType === enums_1.TransformationType.PLAIN_TO_CLASS) {
                exposedProperties = exposedProperties.map(key => {
                    const exposeMetadata = storage_1.defaultMetadataStorage.findExposeMetadata(target, key, this.transformationType);
                    if (exposeMetadata && exposeMetadata.options && exposeMetadata.options.name) {
